...
by Aayush Gupta, Akanksha Chaudhari.

# Environment setup

Clone the repo:
`git clone https://github.com/AayGup/Inpainting.git`
...
- You can use the [script](https://github.com/AayGup/Inpainting/blob/main/bin/gen_mask_dataset.py) for random masks generation. 
